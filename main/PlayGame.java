...
public class PlayGame {
    ...
    public ArrayList<Player> getPlayersArray (Input gameInput, BattleField g, PlayerFactory factory) {
        ...
        for (int i = 0; i < beginningPlayers.size(); ++i) {
            ...
            switch (c) {
                case 'P':
                    gamePlayers.add(factory.getPlayerType(PlayerType.PYRO, i, Constants.INITIAL_PYRO_HP,
                            Constants.PYRO_HP_LEVEL_BONUS, g, beginningPositions.get(i).get(0),
                            beginningPositions.get(i).get(1), 'P'));
                    break;
                case 'R':
                    gamePlayers.add(factory.getPlayerType(PlayerType.ROGUE, i, Constants.INITIAL_ROGUE_HP,
                            Constants.ROGUE_HP_LEVEL_BONUS, g, beginningPositions.get(i).get(0),
                            beginningPositions.get(i).get(1), 'R'));
                    break;
                case 'K':
                    gamePlayers.add(factory.getPlayerType(PlayerType.KNIGHT, i, Constants.INITIAL_KNIGHT_HP,
                            Constants.KNIGHT_HP_LEVEL_BONUS, g, beginningPositions.get(i).get(0),
                            beginningPositions.get(i).get(1), 'K'));
                    break;
                case 'W':
                    gamePlayers.add(factory.getPlayerType(PlayerType.WIZARD, i, Constants.INITIAL_WIZARD_HP,
                            Constants.WIZARD_HP_LEVEL_BONUS, g, beginningPositions.get(i).get(0),
                            beginningPositions.get(i).get(1),'W'));
                    break;
                default:
                    break;
            }
    ...
    public void calculateOvertimeDamage(ArrayList<Player> gamePlayers) {
    ...
    /* Plays the game */
    public void play (Input gameInput, BattleField ground, ReadInput readInput,PlayerFactory factory) {
